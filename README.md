...
其实CTF部分的工具合集在国内还是比较欠缺的，很多都是单纯的收集，对刚入门和一些已经入门但是想要尝试其他方向的师傅都不太友好，所以我们的目的不是单纯的收集，这也是项目名称被叫做 "CTFtools-wiki" 的原因。学习中有一个很大的误区 “收藏” == “学会”，而工具也是，很多时候，工具不具备其本身的意义，当它被下载下来后，更像是一件....“收藏品”。  本项目将尝试修正这样的思维误区，我们更希望让你去选择工具，然后做到真正意义上的去使用工具，而不是做一个工具收藏家。  
